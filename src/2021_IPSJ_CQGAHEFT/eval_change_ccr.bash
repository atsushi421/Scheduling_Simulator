...
WRITE_DURATION=""
WRITE_MAKESPAN=""
DEST_DIR="${PWD}/result/change_ccr"
PYTHON_SCRIPT_DIR="${PWD}/../"


### parse command options
OPT=`getopt -o ha:d: -l help,dag_dir:,algorithm:,num_of_clusters:,num_of_cores:,inout_ratio:,ccr:,write_duration,write_makespan,dest_dir: -- "$@"`
...
### evaluation
DEST_FILE="${DEST_DIR}/${CCR}/${ALGORITHM}.csv"
